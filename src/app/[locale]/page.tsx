      ...
      <main className="flex-1">
        ...
        <section className="relative px-4 py-16 sm:py-24 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 sm:gap-12 items-center">
              ...
              <div className="relative rounded-3xl p-[2px] bg-gradient-to-br from-primary/40 via-primary/5 to-purple-500/30 shadow-2xl">
                <div className="rounded-3xl border bg-background/70 backdrop-blur ring-1 ring-inset ring-border dark:ring-white/10">
                  <div className="relative aspect-[16/10] overflow-hidden">
                    ...
                    <div className="relative h-full w-full p-4 sm:p-8 flex flex-col gap-4 sm:gap-6">
                      ...
                      <div className="flex gap-4 sm:gap-6">
                        <div className="w-1/3 h-40 sm:h-56 rounded-2xl bg-background/40 border border-border dark:border-white/10 ring-0 dark:ring-1 dark:ring-white/5" />
                        <div className="flex-1 h-40 sm:h-56 rounded-2xl bg-background/40 border border-border dark:border-white/10 ring-0 dark:ring-1 dark:ring-white/5" />
                      </div>
                      <div className="mt-auto flex justify-center gap-2 sm:gap-4">
                        <div className="h-8 w-16 sm:w-24 rounded-lg bg-background/40 border border-border dark:border-white/10" />
                        <div className="h-8 w-16 sm:w-24 rounded-lg bg-background/40 border border-border dark:border-white/10" />
                        <div className="h-8 w-16 sm:w-24 rounded-lg bg-primary/40 border border-primary/40 shadow-inner" />
                        <div className="h-8 w-16 sm:w-24 rounded-lg bg-background/40 border border-border dark:border-white/10" />
                        <div className="h-8 w-16 sm:w-24 rounded-lg bg-background/40 border border-border dark:border-white/10" />
                      </div>
                    </div>
            ...
            <div className="order-1 md:order-2 text-left space-y-4 sm:space-y-6">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-5xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-foreground to-foreground/70">
